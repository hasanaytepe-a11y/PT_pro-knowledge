...
**Torakal veya torakolomber eğriliklerde** akciğer fonksiyonları azalır; ileri olgularda **kardiyorespiratuvar kapasite** etkilenir.
...
- **Postür düzeltici ve simetrik core aktivasyonları** (plank varyasyonları, nötral omurga odaklı)  
- **Denge ve propriyosepsiyon çalışmaları** (tek ayak denge, denge tahtası)  
- **Hafif mobilizasyon ve elongasyon egzersizleri** (kontrollü, ağrısız, simetrik)  
...
- Omurgaya yük bindiren ağır squat veya baş üstü press egzersizleri  
- Uzun süreli statik esnetme ve sinir hattı gerilimi oluşturan pozisyonlar  
- Aşırı tek taraflı veya lateral odaklı çalışmalar, kontrolsüz auto-elongation  
...
3. Weiss, H., & Maier-Hennes, A. (2008). *Specific Exercises in the Treatment of Scoliosis – Differential Indication.* Studies in Health Technology and Informatics, 135, 173.  
4. O’Connor, F. G. (2005). *Sport Medicine: Just the Facts.* The McGraw-Hill Companies, Inc.  
