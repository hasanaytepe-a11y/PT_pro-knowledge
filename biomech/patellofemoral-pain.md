...
Patellofemoral ekleme tekrarlayıcı yük binmesi, **kuadriseps ve kalça kas zayıflıkları**, **iliotibial bant (ITB) sertliği** ve **biyomekanik hizalanma bozuklukları** (örneğin diz valgusu, pes planus) ile ilişkilidir.
...
- **ITB, hamstring ve gastro-soleus germe:** Foam roller veya dinamik esnetme  
- **Patellar taping veya tabanlık kullanımı:** Ağrıyı azaltıp yük toleransını artırır  
- **Yürüyüş ve koşu mekaniği eğitimi:** Diz hizalaması ve femoral rotasyon kontrolü odaklı  
...
- Sadece pasif tedavilere (masaj, sıcak uygulama) güvenmek
...
3. Porcari, J., Bryant, C., & Comana, F. (2015). *Exercise Physiology.* FA Davis.  
4. Fredericson, M., & Powers, C. M. (2002). *Practical management of patellofemoral pain.* Clinical Journal of Sport Medicine, 12(1), 36–38.  
